...
<head>
    ...
    <link rel="stylesheet" href="admin/css/tables.css" type="text/css">
...
<!-- Header Section Begin -->
    ...
    <section class="hero-area set-bg" data-setbg="admin/img/herobg.png">
        <div class="container">
            <div class="row">
...
<div class="pricingTable">
  <ul class="pricingTable-firstTable">
    <li class="pricingTable-firstTable_table">
      ...
      <p class="pricingTable-firstTable_table__pricing"><img src="admin/foto_penginapan/<?php echo $row["fotopenginapan"]; ?>" width="100" height="100"> </p>
