...
<!-- Header Section Begin -->
            ...
            <div class="inner-header">
                ...
                <nav class="main-menu mobile-menu">
                    <ul>
                        ...
                        <li class="active"><a href="admin.php?page=keuangantrue">Keuangan</a></li>
    ...
    <BR>
                    <CENTER><P>K E U A N G A N</P>
                    <div class="section-title">
                    <h2>Menghasilkan Uang di PAN-SUB</h2>
                </div>
                <div class="container">
            <div class="row">
<span>  &nbsp</span><span>  &nbsp</span>
                        <h4>Dengan PAN-SUB, nikmati sistem pembayaran tanpa rasa sakit, biaya rendah, dan kebebasan atas apa yang Anda tetapkan.</h4>
                </div>
            </div>
            <br><br><a href="admin.php?page=getstartedtrue" class="primary-btn">Get Started</a>
    </CENTER>
    <!-- Steps Section End -->
...
<br><br><br>
    ...
    <!-- Image Section Begin -->
<center>    <img src="img/blog4.jpg" alt=""></center>
<!-- Image Section End -->
 ...
 <!-- Steps Section Begin -->
    ...
    <BR><br><br>
                    <CENTER><P>=========</P>
                    <div class="section-title">
                    <h2>Pembayaran Mudah & Sederhana</h2><br>
                </div>
                <div class="container">
            <div class="row">
<span>  &nbsp</span><span>  &nbsp</span>
                        <h4>Dapatkan bayaran sesuai keinginan Anda — dengan metode seperti Paypal, setoran langsung, atau lainnya tergantung pada lokasi Anda.</h4>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="services-item">
                        <div class="ti-author">
                            ...
                            <h3>Daftarkan ruang Anda secara gratis</h3><br>
                            <p>Anda dapat mengiklankan rumah Anda kepada jutaan pelancong tanpa ikatan — tanpa biaya pendaftaran atau biaya keanggotaan.</p>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="services-item">
                        <div class="ti-author">
                            ...
                            <h3>Terima pemesanan</h3><br>
                            <p>PAN-SUB menagih setiap tamu sebelum kedatangan untuk memastikan Anda akan selalu dibayar tepat waktu saat menjadi tuan rumah. Anda tidak perlu menangani uang secara langsung.</p>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="services-item">
                        <div class="ti-author">
                            ...
                            <h3>Dapatkan bayaran setelah check-in</h3><br>
                            <p>PAN-SUB biasanya melepaskan uang Anda sekitar 24 jam setelah tamu dijadwalkan tiba untuk memastikan check-in berjalan lancar.</p>
...
<BR><br><br><br><br><br><br><br>
                    <CENTER><P>=========</P>
                    <div class="section-title">
                    <h2>Harga Bagus, Setiap Malam</h2><br>
                </div></CENTER>
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="testimonial-item">
                        ...
                        <h4>Rp100.000.000 perlindungan kerusakan properti</h4>
                            <p><ul>Dalam kasus kerusakan properti yang jarang terjadi, pemilik penginapan di PAN-SUB memberikan perlindungan gratis hingga Rp100.000.000 dalam kerusakan properti untuk setiap pemesanan, setiap saat.</ul>
                                <ul>Klaim dapat diajukan langsung melalui Pusat Resolusi kami.</ul></p>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="callto-section">
        <div class="container">
            ...
            <a href="admin.php?page=getstartedtrue" class="primary-btn">Get Started</a>
        </div>
    </section>
    <!-- Call To Action End  -->
